...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Quadrivae Core quadrivae-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quadrivae-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quadrivae transaction") + "\n" +
                               "  quadrivae-tx [options] -create [commands]   " + _("Create hex-encoded quadrivae transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quadrivae transaction
