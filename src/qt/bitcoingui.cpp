                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Quadrivae Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quadrivae: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zQUAD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Quadrivae Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quadrivae Core"));
    ...
    openAction->setStatusTip(tr("Open a Quadrivae: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quadrivae Core help message to get a list with possible Quadrivae command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Quadrivae Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Quadrivae Core"); // default title
