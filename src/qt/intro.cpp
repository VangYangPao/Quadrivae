...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Quadrivae Core"),
     ...
     * override -datadir in the quadrivae.conf file in the default data directory
     * (to be consistent with quadrivaed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
