...
public:
    ...
    void setZQuadrivaeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzQUAD_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzQUAD_clicked();
    void on_pushButtonZQuadrivaeControl_clicked();
