...
/** Utility functions used by the Quadrivae Qt UI.
 */
namespace GUIUtil
{
...
// Render Quadrivae addresses in monospace font
...
// Parse "quadrivae:" URI into recipient object, return true on successful parsing
