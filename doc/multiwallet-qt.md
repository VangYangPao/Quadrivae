...
In order to support loading of multiple wallets in quadrivae-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is quadrivae.cpp.
...
Changes to quadrivae.cpp
----------------------
quadrivae.cpp is the entry point into quadrivae-qt, and as such, will require some minor modifications to provide hooks for
