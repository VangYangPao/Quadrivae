...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/quadrivae-cli.cpp \
           src/quadrivae-tx.cpp \
           src/quadrivae.cpp \
           src/db.cpp \
           ...
           src/qt/quadrivae.cpp \
           src/qt/quadrivaestrings.cpp \
...
RESOURCES += src/qt/quadrivae.qrc src/qt/quadrivae_locale.qrc

TRANSLATIONS += src/qt/locale/quadrivae_bg.ts \
                src/qt/locale/quadrivae_de.ts \
                src/qt/locale/quadrivae_en.ts \
                src/qt/locale/quadrivae_es.ts \
                src/qt/locale/quadrivae_fi.ts \
                src/qt/locale/quadrivae_fr.ts \
                src/qt/locale/quadrivae_it.ts \
                src/qt/locale/quadrivae_ja.ts \
                src/qt/locale/quadrivae_pl.ts \
                src/qt/locale/quadrivae_pt.ts \
                src/qt/locale/quadrivae_ru.ts \
                src/qt/locale/quadrivae_sk.ts \
                src/qt/locale/quadrivae_sv.ts \
                src/qt/locale/quadrivae_vi.ts \
                src/qt/locale/quadrivae_zh_CN.ts \
                src/qt/locale/quadrivae_zh_TW.ts
