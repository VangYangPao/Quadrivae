Contributing to Quadrivae Core
============================

The Quadrivae Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Quadrivae Core project, and is not to be
confused with overall Quadrivae Network Protocol consensus changes.

Whether a pull request is merged into Quadrivae Core rests with the project merge
...
Patches that change Quadrivae consensus rules are considerably more involved than
...
Where a patch set proposes to change the Quadrivae consensus, it must have been
...
The project leader is the release manager for each Quadrivae Core release.
